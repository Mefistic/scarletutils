...
std::unordered_set<int> filter = {2015, 15, 16, 17, 221, 743, 744, 899, 900, 915, 1006, 32, 33, 29, 30, 104, 105, 717, 718, 1007, 1520, 2903, 3029, 3030, 3031, 2999, 3606, 3612, 3009, 3010, 3014, 3015, 3021, 3020, 1818, 1819, 1612, 1613, 3608};
          ...
          if (ImGui::BeginTabItem("Visual")) {
            ...
            if (ImGui::BeginPopup("layout mode options")) {
              ...
              if (ImGui::IsItemEdited()) {
                ...
                ccHSVValue hsv = {0,0,0};
                if (PlayLayer::get()) PlayLayer::get()->updateColor(layoutModeColorBackground, 0.0f, 1000, false, 1.0f, hsv, 0, false, nullptr, 0, 0);
              }
              ...
              if (ImGui::IsItemEdited()) {
                ...
                ccHSVValue hsv = {0,0,0};
                if (PlayLayer::get()) PlayLayer::get()->updateColor(layoutModeColorBackground, 0.0f, 1001, false, 1.0f, hsv, 0, false, nullptr, 0, 0);
              }
